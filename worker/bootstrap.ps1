...
# files get synced in on top. To re-approve a machine whose session was
# revoked, add -Reconnect (needs an existing -Dir checkout with a
...
if ($AllowInsecureUrl) { $setupArgs.AllowInsecureUrl = $true }
